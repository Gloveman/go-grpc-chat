...
* [ ] API 정의 수정
   * [ ] 로비 서버 (global 서버) 접속 및 DM 수신을 위한 RPC 추가
   * [ ] 유저 리스트 조회 RPC 추가
   * [ ] ChatMesssage에 DM 전송 상대방 닉네임 필드 추가   
* [ ] 서버 구현
    * [ ] 입력한 닉네임이 서버에 존재하는지 검사
    * [ ] DM 전송 기능 추가
    * [ ] 서버 전체 유저 리스트/참여 방 유저 리스트 조회 추가
* [ ] 클라이언트 구현
    * [ ] DM 수신을 위한 goroutine 추가
    * [ ] 유저 조회 추가
    * [ ] DM 명령어, 유저 리스트 조회 명령어 추가
