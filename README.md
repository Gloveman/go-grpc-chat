...
* [ ] API 정의 수정
   * [ ] 파일 보내기/다운받기 RPC 추가
   * [ ] 파일 메타데이터 Message 추가
   * [ ] 업로드/다운로드 상태 관리 Message 추가   
   * [ ] ChatMessage에 파일 정보 필드 추가
* [ ] 서버 구현
    * [ ] chunk 단위 파일 업로드, 다운로드 처리 - 파일 크기 제한
    * [ ] 다운로드 시 권한 있는 사용자인지 확인(보낸 사람과 같은 방 or DM으로 받음)
    * [ ] 업로드 실패 시 서버 내 파일 삭제
* [ ] 클라이언트 구현
    * [ ] 탐색기 dialog를 통한 파일 선택 후 업로드 기능
    * [ ] dialog로 지정한 경로에 파일 다운로드 기능
* [ ] 최종 테스트 및 릴리즈 배포
* [ ] 프로그램 실행 방법 작성